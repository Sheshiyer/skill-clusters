...
**Before executing, check for optional user customizations** in a sibling `USER/` override directory if your environment defines one. If present, load and apply any `PREFERENCES.md`, configurations, or resources found there — these override default behavior. Otherwise proceed with skill defaults.

## Workflow Routing

**When executing a workflow, announce which one you're running:**
...
→ **READ:** `Workflows/Find-aphorism.md` (relative to this skill)
...
→ **READ:** `Workflows/Add-aphorism.md` (relative to this skill)
...
→ **READ:** `Workflows/Research-thinker.md` (relative to this skill)
...
→ **READ:** `Workflows/Search-aphorisms.md` (relative to this skill)
...
**Location:** `Database/aphorisms.md` (relative to this skill)

**Current Collections:**
1. **Initial Collection** - 15 curated quotes covering core themes
2. **Featured Thinkers** - Sections for Hitchens, Deutsch, Harris, Spinoza, Feynman (to be populated)
...
**Database Location:**
`Database/aphorisms.md` (relative to this skill)

**Current Collection Size:**
- 15 initial quotes (starter collection)
