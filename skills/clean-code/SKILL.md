---
name: clean-code
description: "Apply Robert C. Martin (Uncle Bob) Clean Code principles — meaningful names, small single-purpose functions, comment discipline, error handling, and code-smell heuristics — to transform code that works into code that is clean. USE WHEN reviewing a PR for maintainability, refactoring legacy code, or aligning a team on readability standards."
