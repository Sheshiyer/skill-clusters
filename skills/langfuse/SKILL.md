---
name: langfuse
description: "Langfuse expert for open-source LLM observability: tracing, prompt management, evaluation, datasets, and integrations with LangChain, LlamaIndex, and OpenAI. USE WHEN you need to trace, monitor, or debug an LLM app in production with Langfuse."
