...
5. If site copy matters, include the current landing page and repo/product framing.
...
## House Voice Defaults

If the user wants a default operator/founder house voice and live sources are thin, start here unless newer source material overrides it:
