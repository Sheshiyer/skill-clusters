...
description: "Diagnose slow React components and apply targeted fixes — isolate ticking state, stabilize props/handlers, memoize leaves, virtualize lists, verify with the Profiler. USE WHEN a React component is slow, janky, or re-rendering too much."
