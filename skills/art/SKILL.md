---
name: art
description: Complete visual content system. USE WHEN user wants to create visual content, illustrations, diagrams, OR mentions art, header images, visualizations, mermaid, flowchart, technical diagram, infographic, app icon, or pack icon.
cluster: media-gen
version: 1.0.0
---
...
`~/.Codex/skills/CORE/USER/SKILLCUSTOMIZATIONS/Art/`
...
**Load customizations from:** `~/.Codex/skills/CORE/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md`
...
bun run ~/.Codex/skills/Art/Tools/Generate.ts \
...
**API keys in:** your agent config `.env` (e.g. `~/.agents/.env`)
