...
description: Master iOS Human Interface Guidelines and SwiftUI patterns for building native iOS apps. USE WHEN designing iOS interfaces to Apple's HIG, laying out SwiftUI views/grids/navigation, choosing SF Symbols and Dynamic Type, or making an app feel native across iPhone and iPad (Dark Mode, accessibility, adaptive layout).
cluster: native-ios
version: 1.0.0
---
