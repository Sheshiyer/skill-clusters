...
description: "Query Hugging Face datasets through the Dataset Viewer API for splits, rows, full-text search, filters, and parquet links (read-only). USE WHEN you need read-only exploration or extraction from a Hugging Face dataset."
