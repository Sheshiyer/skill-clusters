---
name: seo-sitemap
description: "Analyze existing XML sitemaps or generate new ones with industry templates — validates format, URL limits, lastmod, canonical/noindex hygiene, and sitemap-index splitting. USE WHEN a user mentions sitemap, generate sitemap, sitemap issues, or XML sitemap."
cluster: growth-seo
version: 1.0.0
