---
name: segment-cdp
description: "Segment Customer Data Platform engineering patterns — Analytics.js, server-side tracking, tracking plans with Protocols, identity resolution, destinations config, and data governance. USE WHEN instrumenting a product with Segment to capture clean customer event data and route it to downstream marketing/analytics tools."
