---
name: wrangler
description: "Cloudflare Workers CLI for deploying and managing Workers, KV, R2, D1, Vectorize, Hyperdrive, Workers AI, Containers, Queues, Workflows, Pipelines, and Secrets Store. USE WHEN running any wrangler command, deploying or dev-serving a Worker, or provisioning Cloudflare storage and compute bindings."
cluster: cloudflare
version: 1.0.0
---
