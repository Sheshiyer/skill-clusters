...
`~/.Codex/skills/PAI/USER/SKILLCUSTOMIZATIONS/Fabric/`
...
**Full documentation:** `~/.Codex/skills/PAI/THENOTIFICATIONSYSTEM.md`
...
**Patterns Location:** `~/.Codex/skills/Fabric/Patterns/`
...
| Path | Purpose |
|------|---------|
| `~/.Codex/skills/Fabric/Patterns/` | Local pattern storage (240+) |
| `~/.Codex/skills/Fabric/PatternCatalog.md` | Full pattern documentation |
| `~/.Codex/skills/Fabric/Workflows/` | Execution workflows |
| `~/.Codex/skills/Fabric/Tools/` | CLI utilities |
