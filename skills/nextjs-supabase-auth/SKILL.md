...
description: "Integrate Supabase Auth with the Next.js App Router — browser/server clients, middleware session refresh, and the auth callback route. USE WHEN wiring Supabase login, sessions, or protected routes into a Next.js app."
