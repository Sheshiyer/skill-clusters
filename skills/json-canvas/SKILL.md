---
name: json-canvas
description: "Create and edit JSON Canvas files (.canvas) with nodes, edges, groups, and connections per the JSON Canvas 1.0 spec. USE WHEN working with .canvas files or building visual canvases, mind maps, knowledge maps, or flowcharts (e.g. in Obsidian)."
