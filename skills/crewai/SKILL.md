---
name: crewai
description: "CrewAI expert for role-based multi-agent systems: agents with roles/goals, task definitions, sequential/hierarchical/parallel crews, memory, and flows. USE WHEN orchestrating a multi-agent crew with the CrewAI framework."
