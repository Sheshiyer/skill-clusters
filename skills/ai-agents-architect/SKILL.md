...
description: "Design and build autonomous AI agents: ReAct and plan-and-execute loops, tool registries, hierarchical memory, supervisor patterns, and checkpoint recovery. USE WHEN architecting an autonomous agent's control loop, tools, and memory from scratch."
