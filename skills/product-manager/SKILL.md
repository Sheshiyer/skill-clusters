...
description: "Senior PM agent spanning strategy, discovery, prioritization, execution, and metrics — 30+ frameworks (RICE, JTBD, Kano, North Star), 12 templates (PRDs, roadmaps), and 32 SaaS metrics with formulas. USE WHEN you need structured product-management analysis: PRDs, roadmaps, prioritization, launch planning, or SaaS metric calculations."
