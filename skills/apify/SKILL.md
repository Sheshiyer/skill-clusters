...
`~/.Codex/skills/PAI/USER/SKILLCUSTOMIZATIONS/Apify/`
...
**Architecture:** See `~/.Codex/skills/PAI/DOCUMENTATION/FileBasedMCPs.md`
...
```typescript
import { scrapeInstagramProfile, searchGoogleMaps } from '~/.Codex/skills/Apify/actors'
...
```typescript
import { scrapeInstagramProfile, scrapeInstagramPosts } from '~/.Codex/skills/Apify/actors'
...
**LinkedIn - Job search:**
```typescript
import { searchLinkedInJobs } from '~/.Codex/skills/Apify/actors'
...
```typescript
import { scrapeTikTokHashtag } from '~/.Codex/skills/Apify/actors'
...
```typescript
import { searchGoogleMaps } from '~/.Codex/skills/Apify/actors'
...
```typescript
import { scrapeGoogleMapsReviews } from '~/.Codex/skills/Apify/actors'
...
```typescript
import { scrapeAmazonProduct } from '~/.Codex/skills/Apify/actors'
...
```typescript
import { scrapeWebsite } from '~/.Codex/skills/Apify/actors'
...
```typescript
import { searchGoogleMaps, scrapeLinkedInProfile } from '~/.Codex/skills/Apify/actors'
