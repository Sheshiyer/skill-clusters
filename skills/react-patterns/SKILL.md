...
The hooks ruleset in short — highlights:
...
- Skills: [react-performance](../react-performance/SKILL.md) for the Vercel-derived performance ruleset, [react-testing](../react-testing/SKILL.md), [make-interfaces-feel-better](../make-interfaces-feel-better/SKILL.md) for cross-framework UI polish, [accessibility](../accessibility/SKILL.md), [angular-developer](../angular-developer/SKILL.md) for framework comparison
