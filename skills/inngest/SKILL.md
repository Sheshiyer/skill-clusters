---
name: inngest
description: "Inngest expert for serverless-first background jobs, event-driven workflows, and durable execution without managing queues or workers. USE WHEN building background jobs, durable multi-step workflows, fan-out, or scheduled functions on Inngest instead of running your own queue/worker infra."
