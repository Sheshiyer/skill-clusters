...
description: "Deploy Next.js apps to Vercel — environment variables across environments, edge/serverless functions, build config, and production rollout. USE WHEN configuring or shipping a Next.js project on Vercel."
