...
description: "Build cross-browser extensions (Chrome/Firefox) — Manifest V3 architecture, content scripts, service workers, popup UIs, monetization, and Web Store publishing. USE WHEN building, structuring, or publishing a browser extension."
