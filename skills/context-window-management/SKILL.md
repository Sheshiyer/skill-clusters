...
description: "Strategies for managing LLM context windows including summarization, trimming, routing, token counting, prioritization, and avoiding context rot. USE WHEN an agent run is overflowing its context window or degrading from context rot."
