---
name: watchos
description: watchOS development guidance including SwiftUI for Watch, Watch Connectivity, complications, and watch-specific UI patterns. USE WHEN building a watchOS app or Watch extension, syncing iPhone <-> Watch data, building watch-face complications (ClockKit or WidgetKit), tracking workouts/HealthKit on watch, or shipping Smart Stack widgets for watchOS.
cluster: native-ios
version: 1.0.0
