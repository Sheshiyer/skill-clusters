...
description: "Full-stack diagnostic that audits the 12-layer agent stack for wrapper regression, memory pollution, tool-discipline failures, hidden repair loops, and rendering corruption, producing severity-ranked code-first fixes. USE WHEN debugging or reviewing agent, autonomous-loop, or LLM-powered apps."
