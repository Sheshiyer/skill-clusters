...
description: "Review and fix Swift 6.2+ concurrency diagnostics — actor isolation, Sendable violations, @MainActor placement, isolated conformances, and @concurrent offloading — with the smallest behavior-preserving edit. USE WHEN the compiler reports a data-race / Sendable error or you need to triage and fix a concrete concurrency diagnostic."
cluster: native-ios
version: 1.0.0
