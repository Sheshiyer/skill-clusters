...
description: "Build or edit Gradio apps, layouts, components, and chat interfaces in Python for ML demos and UI prototypes. USE WHEN a user wants a Gradio demo or Python ML interface for a model or agent."
