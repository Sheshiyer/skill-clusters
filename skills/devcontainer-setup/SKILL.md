...
description: "Creates devcontainers with the agent CLI, language-specific tooling (Python/Node/Rust/Go), and persistent volumes. USE WHEN adding devcontainer support to a project, setting up isolated development environments, or configuring sandboxed coding-agent workspaces."
