...
version: 1.0.0
description: Analyzes meeting transcripts and recordings to uncover behavioral patterns, communication insights, and actionable feedback. Identifies when you avoid conflict, use filler words, dominate conversations, or miss opportunities to listen. USE WHEN analyze a meeting transcript/recording for communication patterns, get feedback on how I ran a meeting, review my speaking habits.
---
