...
description: "Audit and rewrite prose to strip 21 categories of AI writing patterns using a 43-entry replacement table, then re-audit the rewrite. USE WHEN asked to remove AI-isms, make text sound less like AI, or polish a draft for AI tells before publishing."
