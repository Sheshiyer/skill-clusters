...
description: "Use the Hugging Face Hub CLI (hf) for authentication, downloading, uploading, and managing models, datasets, and Spaces. USE WHEN you need to authenticate to or move models/datasets/Spaces on the Hugging Face Hub via CLI."
