---
name: seo-dataforseo
description: "Use DataForSEO for live SERPs, keyword metrics, backlinks, competitor analysis, on-page checks, and AI-visibility data via its MCP server. USE WHEN a user needs real, live SEO data (rankings, volumes, backlinks, LLM mentions) rather than static best-practice guidance."
cluster: growth-seo
version: 1.0.0
