...
description: "BullMQ expert for Redis-backed job queues, background processing, retries/backoff, dead-letter queues, concurrency limits, and reliable async execution in Node.js/TypeScript. USE WHEN an agent or backend needs durable background jobs or an async work queue on Redis."
