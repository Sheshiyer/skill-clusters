...
description: "Deploy and manage Vercel projects via the CLI using token-based auth (VERCEL_TOKEN) instead of interactive login. USE WHEN deploying to Vercel, setting env vars, or running Vercel CLI in CI without vercel login."
