...
description: "Read and analyze Hugging Face paper pages or arXiv papers using markdown and the papers API metadata. USE WHEN you need to read, summarize, or pull metadata for an arXiv or HF paper."
