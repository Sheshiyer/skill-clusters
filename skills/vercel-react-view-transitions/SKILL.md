...
description: "Animate React/Next.js UI state with native view transitions — shared elements, route transitions, transition types, and reduced-motion-safe patterns. USE WHEN adding view transitions or shared-element route animations in React."
