...
description: "Build, run, and debug the current iOS project on a booted simulator via XcodeBuildMCP — UI interaction, screenshots, view inspection, and runtime log capture. USE WHEN you need to run an iOS app on a simulator, reproduce a bug, tap/type through a flow, or capture console logs."
cluster: native-ios
version: 1.0.0
