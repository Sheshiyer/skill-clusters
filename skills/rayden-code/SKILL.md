---
name: rayden-code
description: "Generate production React + Tailwind code with the Rayden UI component library (34 components) using correct props, tokens, layouts, and an anti-pattern ban list. USE WHEN scaffolding pages/dashboards with the Rayden/Rayna design system."
...
> Upstream source: https://github.com/playbookTV/rayden-ui-design-skill (author: Leslie Williams) · packaged via antigravity-awesome-skills (MIT)
