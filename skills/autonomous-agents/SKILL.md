...
description: "Build reliable autonomous agents that decompose goals, plan, execute tools, and self-correct, focusing on bounding failure probability across multi-step runs. USE WHEN making an unattended autonomous agent reliable rather than merely capable."
