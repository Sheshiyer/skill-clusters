...
description: "Apply proven SwiftUI patterns for NavigationStack routing, enum-driven sheets, async .task state, deep links, previews, and reusable screens with correct state ownership. USE WHEN building or refactoring SwiftUI screens/flows and you need concrete navigation, sheet, async-state, or component-composition guidance."
cluster: native-ios
version: 1.0.0
