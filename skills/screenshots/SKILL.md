---
name: screenshots
description: "Generate marketing-quality, true-retina (2x) app screenshots with Playwright — discover routes/features from the codebase, handle login, and capture each view. USE WHEN a user wants screenshots for Product Hunt, social media, a landing page, or documentation."
cluster: documents
version: 1.0.0
