...
description: "Build, refactor, or review SwiftUI macOS menubar (LSUIElement) apps with a Tuist-first workflow, stable launch scripts, and strict model/client/store/view boundaries. USE WHEN working on a menu bar utility built with Tuist — manifests, run scripts, or keeping networking and state out of view bodies."
cluster: native-ios
version: 1.0.0
