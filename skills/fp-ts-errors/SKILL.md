---
name: fp-ts-errors
description: "Handle errors as values in TypeScript using fp-ts Either and TaskEither instead of try/catch, with validation-error accumulation. USE WHEN you want type-safe explicit error handling in TS APIs or services."
