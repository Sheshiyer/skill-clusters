...
description: "Train or fine-tune vision models on Hugging Face Jobs for object detection, image classification, and SAM/SAM2 segmentation on managed GPUs. USE WHEN fine-tuning a detection, classification, or SAM segmentation model on HF Jobs."
