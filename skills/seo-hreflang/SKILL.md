---
name: seo-hreflang
description: "Hreflang and international SEO audit, validation, and generation — self-referencing/return tags, x-default, ISO language/region code validation, and HTML/header/sitemap output. USE WHEN a user mentions hreflang, i18n SEO, international SEO, multi-language, multi-region, or language tags."
cluster: growth-seo
version: 1.0.0
