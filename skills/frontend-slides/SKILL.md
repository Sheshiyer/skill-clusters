...
- `react-patterns` and `make-interfaces-feel-better` for component and interaction polish around the deck
- `motion-foundations` / `motion-patterns` for accessible, performant slide animation
- `accessibility` if you need WCAG-grade verification for the final deck
