...
version: 1.0.0
description: |
  Fireflies integration. Manage Organizations. USE WHEN the user wants to interact with Fireflies meeting data — list/search meetings, pull transcripts, or call the Fireflies API.
