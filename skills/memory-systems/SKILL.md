---
name: memory-systems
description: "Design short-term, long-term, and graph-based memory architectures for agents that persist across sessions, maintain entity consistency, and reason over accumulated knowledge. USE WHEN choosing and designing the right memory architecture for a persistent agent."
