...
description: "AI-powered E2E web testing — declarative YAML scenarios run via Playwright with visual matching (OpenCV + OCR) and framework auto-detection. USE WHEN you need AI-driven browser end-to-end tests without brittle DOM selectors."
