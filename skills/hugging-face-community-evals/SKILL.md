...
description: "Run local evaluations of Hugging Face Hub models with inspect-ai or lighteval, including backend selection and GPU smoke tests. USE WHEN evaluating a Hugging Face model on local hardware outside the Jobs workflow."
