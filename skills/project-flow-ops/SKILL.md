...
| Port/Rebuild | useful idea, but should be manually re-landed inside the agent stack |
...
- External-source features should be rebuilt inside the agent stack when they are valuable but not self-contained
...
- "Map GitHub issues into our internal 1.x and 2.0 program lanes"
