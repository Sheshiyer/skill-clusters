---
name: prompt-caching
description: "Caching strategies for LLM prompts including Anthropic prompt caching, response caching, and Cache-Augmented Generation (CAG) to cut latency and cost. USE WHEN you want to reduce LLM cost/latency by caching prompt prefixes or responses."
