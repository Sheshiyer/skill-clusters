...
description: Advanced motion patterns for React / Next.js — drag & drop, gestures, text animations, SVG path drawing, custom hooks, imperative sequences (useAnimate), loaders, and the full API decision tree. USE WHEN motion-patterns is not enough and you need gestures, SVG, or imperative sequences.
version: 1.0.0
