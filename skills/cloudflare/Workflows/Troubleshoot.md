...
**Prefer browser automation over curl for verification.** Use Chrome MCP tools (`browser navigate/screenshot/act`) to drive Chrome and confirm the deployed site actually loads and behaves correctly — a 200 from curl does not prove the page renders.
