...
description: "Design agent tools from JSON Schema to error handling and MCP exposure, writing LLM-legible descriptions, validation, and token-efficient interfaces that avoid silent failures. USE WHEN defining or hardening the tools/functions an LLM agent can call."
