...
`~/.Codex/skills/CORE/USER/SKILLCUSTOMIZATIONS/Research/`
...
**Full documentation:** `~/.Codex/skills/CORE/SYSTEM/THENOTIFICATIONSYSTEM.md`
...
- Quick/minor research (1 Codex, 1 query) -> `Workflows/QuickResearch.md`
- Standard research - DEFAULT (2 agents: Codex + Gemini) -> `Workflows/StandardResearch.md`
...
- Codex WebSearch only (free, no API keys) -> `Workflows/ClaudeResearch.md`
...
| Trigger | Mode | Speed |
|---------|------|-------|
| "quick research" | 1 Codex agent | ~10-15s |
...
**Scratch (temporary work artifacts):** `~/.Codex/MEMORY/WORK/{current_work}/scratch/`
- Read `~/.Codex/MEMORY/STATE/current-work.json` to get the `work_dir` value
...
**History (permanent):** `~/.Codex/History/research/YYYY-MM/YYYY-MM-DD_[topic]/`
