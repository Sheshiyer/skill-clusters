---
name: obsidian-cli
description: "Drive the Obsidian CLI to read, create, search, append, and manage vault notes, or develop/debug Obsidian plugins and themes from the shell. USE WHEN a user wants command-line interaction with a running Obsidian vault or scripted note management."
