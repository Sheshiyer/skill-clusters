---
name: seo-images
description: "Image optimization analysis for SEO and Core Web Vitals — alt text, file sizes, WebP/AVIF formats, responsive srcset, lazy loading, fetchpriority, and CLS prevention. USE WHEN a user mentions image optimization, alt text, image SEO, image size, or an image audit."
cluster: growth-seo
version: 1.0.0
