...
`~/.Codex/skills/PAI/USER/SKILLCUSTOMIZATIONS/BrightData/`
...
→ **READ:** ~/.Codex/skills/brightdata/Workflows/Four-tier-scrape.md
...
1. **Tier 1: WebFetch** - Fast, simple, built-in Codex tool
...
**Integration Points:**
- **WebFetch Tool** - Built-in Codex tool for basic URL fetching
...
- `~/.Codex/skills/PAI/SkillSystem.md` - Canonical structure guide
- `~/.Codex/skills/PAI/CONSTITUTION.md` - Overall PAI philosophy
