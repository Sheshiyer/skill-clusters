...
description: "Observability-first Vercel optimization audit — pull production metrics, gate investigations deterministically, and emit version-aware cost/perf recommendations. USE WHEN auditing a deployed Vercel app for cost or performance issues."
...
> Upstream source: https://github.com/vercel-labs/agent-skills · packaged via antigravity-awesome-skills (MIT)
