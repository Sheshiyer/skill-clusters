---
name: secupdates
description: Security news aggregation from tldrsec, no.security, and other sources. USE WHEN security news, security updates, what's new in security, breaches, security research, sec updates.
context: fork
cluster: security
version: 1.0.0
...
**Custom sources:** Add to this skill's `sources.json`.
