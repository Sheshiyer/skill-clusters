...
description: "Expert patterns for HubSpot CRM integration with the Node.js and Python SDKs — OAuth authentication, CRM objects, associations, batch operations, webhooks, and custom objects. USE WHEN integrating an app with HubSpot CRM, syncing contacts/deals, wiring webhooks, or building a public/multi-account HubSpot app."
