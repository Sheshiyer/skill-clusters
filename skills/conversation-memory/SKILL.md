...
description: "Persistent conversation memory with tiered short/long-term stores, entity memory, per-user isolation, importance filtering, and memory-aware prompting. USE WHEN an assistant must remember users across sessions without leaking memory between them."
