...
description: "Train or fine-tune language models with TRL on Hugging Face Jobs, covering SFT, DPO, GRPO, and GGUF export with results saved to the Hub. USE WHEN fine-tuning an LLM (SFT/DPO/GRPO) on managed Hugging Face GPUs."
