...
description: "Run Hugging Face models in JavaScript or TypeScript with Transformers.js, in Node.js or the browser (including WebGPU). USE WHEN running ML inference client-side or in Node with Transformers.js."
