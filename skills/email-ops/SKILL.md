---
name: email-ops
description: Evidence-first mailbox triage, drafting, send verification, and sent-mail-safe follow-up workflow for an autonomous agent operator. Use when the user wants to organize email, draft or send through the real mail surface, or prove what landed in Sent.
origin: ECC
cluster: agentic-ops
version: 1.0.0
---
