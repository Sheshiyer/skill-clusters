---
name: messages-ops
description: Evidence-first live messaging workflow for an autonomous agent operator. Use when the user wants to read texts or DMs, recover a recent one-time code, inspect a thread before replying, or prove which message source was actually checked.
origin: ECC
cluster: agentic-ops
version: 1.0.0
---
