...
description: "Reviews and authors Cloudflare Workers code against production best practices, biasing toward Cloudflare docs. USE WHEN writing a new Worker, reviewing Worker code, configuring wrangler.jsonc, or checking anti-patterns in streaming, floating promises, global state, secrets, bindings, or observability."
cluster: cloudflare
version: 1.0.0
---
