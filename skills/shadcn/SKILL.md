---
name: shadcn
description: "Manage shadcn/ui components and projects — add from registries via the CLI, compose, style with semantic tokens, and follow enforced rules. USE WHEN adding, composing, styling, or debugging shadcn/ui components and design systems."
...
> Upstream source: https://github.com/shadcn-ui/ui/tree/main/skills/shadcn · packaged via antigravity-awesome-skills (MIT)
