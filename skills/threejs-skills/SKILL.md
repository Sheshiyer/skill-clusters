---
name: threejs-skills
description: "Create high-quality 3D scenes and interactive experiences with Three.js best practices — scene setup, lighting, controls, animation loops, and effects. USE WHEN building Three.js/WebGL graphics, 3D visualizations, or interactive scenes."
...
> Upstream source: https://github.com/CloudAI-X/threejs-skills · packaged via antigravity-awesome-skills (MIT)
