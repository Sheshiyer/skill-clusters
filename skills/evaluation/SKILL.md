---
name: evaluation
description: "Build evaluation frameworks for non-deterministic agent systems: rubric design, eval methodologies, test-set design, context-engineering eval, and continuous evaluation. USE WHEN you need to stand up an eval framework to validate or compare agent behavior."
