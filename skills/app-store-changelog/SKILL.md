...
description: "Generate user-facing App Store release notes from git history since the last tag, grouped into New/Improved/Fixed with internal commits filtered out. USE WHEN drafting What's New text, release notes, or changelog bullets for an App Store / TestFlight submission."
cluster: native-ios
version: 1.0.0
